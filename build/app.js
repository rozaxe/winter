...
(function (Winter) {
    var HatStand = (function (_super) {
        ...
        function HatStand(game, x, y, snowman) {
            ...
            this.add(new Winter.Hat(this.game, 75, 'melon_hat', 0, snowman));
            this.add(new Winter.Hat(this.game, 105, 'flat_hat', 1, snowman));
        }
        return HatStand;
    })(Phaser.Group);
...
(function (Winter) {
    var ClothesStand = (function (_super) {
        ...
        function ClothesStand(game, x, y, snowman) {
            ...
            this.add(new Winter.Clothe(this.game, 105, 'green_scarf', snowman));
        }
        return ClothesStand;
    })(Phaser.Group);
